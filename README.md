Descripción del Contexto Título: Aplicación de Gestión Clínica Móvil (Esculappmed) La aplicación Esculappmed se concibe como una herramienta móvil para la gestión básica de información en un entorno clínico o de consultorio.
...
Conceptos del Framework Arquitectura de Ionic Framework Ionic es un framework de desarrollo de aplicaciones móviles híbridas que permite construir aplicaciones nativas utilizando tecnologías web (HTML, CSS, JavaScript).
...
Framework Seleccionado (Angular) Angular es el framework principal utilizado para estructurar la lógica y el estado de la aplicación.
...
Patrones de Diseño En el proyecto se aplicaron principalmente tres patrones de diseño esenciales para el desarrollo de aplicaciones modernas:
